...
uses SysUtils, CastleVectors, CastleBoxes, CastleUtils, Contnrs;
...
type
  ...
  public
    ...
    function FrustumCollisionPossible(const Frustum: TObject): boolean;
...
function TOctreeNode.FrustumCollisionPossible(const Frustum: TObject): boolean;
begin
  Result := true;
end;
